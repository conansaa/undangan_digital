...
class EventCardController extends Controller
{
    ...
    public function storeModalClient(Request $request, $id)
    {
        ...
        return redirect()->route('manageevent.detail', ['id' => $id])->with('success', 'Detail berhasil ditambahkan!');
    }
    ...
    public function updateClient(Request $request, $id)
    {
        ...
        return redirect()->route('manageevent.detail', ['id' => $card->event_id])->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function destroyClient($id)
    {
        ...
        // Hapus data event
        $card->delete();
        return redirect()->route('manageevent.detail', ['id' => $card->event_id])->with('success', 'Data berhasil dihapus.');
    }
}
