...
class MediaAssetController extends Controller
{
    ...
    public function updateClient(Request $request, $id)
    {
        ...
        return redirect()->route('manageevent.detail', ['id' => $media->event_id])->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function destroyClient($id)
    {
        ...
        // Hapus data
        $media->delete();
        return redirect()->route('manageevent.detail', ['id' => $media->event_id])->with('success', 'Data berhasil dihapus.');
    }
}
