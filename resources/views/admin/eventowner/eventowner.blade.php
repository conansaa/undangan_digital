...
@section('pages', 'Pemilik Acara')

@section('pagestitle', 'Pemilik Acara')
        ...
        <table class="table align-items-center mb-0">
            ...
            <tbody>
                @foreach ($eventOwner as $owner)
                    <tr>
                        <td class="align-middle text-center text-secondary text-xs font-weight-bold">{{ $owner->user->name }}</td>
                        <td class="align-middle">
                            <a href="/owners/edit/{{ $owner->id }}">
                                <span class="text-dark"><i class="fa-regular fa-pen-to-square"></i></span>
                            </a>
                            <a href="/owners/delete/{{ $owner->id }}" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
