...
@section('pages', 'Kategori Tema')

@section('pagestitle', 'Kategori Tema')
...
<div class="card">
    <div class="card-header pb-0 mb-2">
        <div class="d-flex justify-content-between align-items-center">
            <h6 class="mb-0">Kategori Tema</h6>
        ...
        <table class="table align-items-center mb-0">
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        <td class="align-middle text-center text-secondary text-xs font-weight-bold">{{ $category->name }}</td>
