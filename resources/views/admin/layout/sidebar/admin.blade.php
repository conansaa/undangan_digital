...
<li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link  {{ Request::is('admin/themes*') ? 'active' : '' }}" href="/admin/themes">
  ...
  <li class="nav-item">
    <a class="nav-link {{ Request::is('owners*') ? 'active' : '' }}" href="/owners">
      ...
      <span class="nav-link-text ms-1">Pemilik Acara</span>
    </a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link {{ request()->is('event-reports') ? 'active' : '' }}" href="/event-reports">
      ...
      <span class="nav-link-text ms-1">Laporan Acara</span>
    </a>
  </li>
  <li class="nav-item">
