...
<body>
  <!-- opening -->
  <section id="opening">
    <div class="section section-opening" style="background-image: url({{ asset('images/177A8157.JPG') }}); background-size: cover; background-position: 50% 55%; padding: 40px; border-radius: 8px; color: white;">
        <div class="content">
  ...
  <script>
    ...
    <section id="story" class="story" style="background-image: url({{ asset('images/bg 4.png') }}); background-size: cover; background-position: center; padding: 40px; border-radius: 8px; color: white;">
    ...
    <div class="app-container">
        ...
        <form action="{{ route('comment.store', ['name' => $name]) }}#comment" method="POST" id="commentForm">
            @csrf
